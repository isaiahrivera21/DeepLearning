...
#all the lineats should be changed to Model 
import pytest
...
def test_additivity():
    ...
    a = rng.normal(shape=[num_inputs, M])
    b = rng.normal(shape=[num_inputs, M])
...
@pytest.mark.parametrize("num_outputs", [1, 16, 128])
def test_dim_basis(num_outputs):
    import tensorflow as tf 
...
# test dimensionality for basis 
# test linearity homogenarity and dimesninality for basis 